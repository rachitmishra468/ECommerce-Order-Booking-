...
public class SplashActivity extends AppCompatActivity {
   ...
   public static String  string="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initLayout();
        getApplicationVersionName(SplashActivity.this);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if(PlayStoreVersion.equals(string)){
                    ...
                    Intent  intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.uk.restaurant.GreenVich"));
